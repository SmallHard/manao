  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin ajax" method="post" action="./ajax.php">
        ...
        <input name="username" type="text" class="input-block-level" placeholder="Username" autofocus size="15" maxlength="15">
        <input name="password" type="password" class="input-block-level" placeholder="Password" size="15" maxlength="15">
