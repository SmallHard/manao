...
$result = mysqli_query($sql, $con)or die("Error MySQL".$sql);
    ...
    <div class="container">
      ...
      <form class="form-signin ajax" method="post" action="./ajax.php">
        ...
        <h2 class="form-signin-heading">Please sign up</h2>
          <input type="text" name="login" class="input-block-level" placeholder="Enter login">
        <input name="username" type="text" class="input-block-level" placeholder="Name" autofocus>
        ...
        <input type="text" name="email" class="input-block-level" placeholder="Enter email">
